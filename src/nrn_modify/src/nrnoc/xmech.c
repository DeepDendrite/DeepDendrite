...
#define nrn_init _nrn_init__Xmech
#define _nrn_initial _nrn_initial__Xmech
#define nrn_cur _nrn_cur__Xmech
#define _nrn_current _nrn_current__Xmech
#define nrn_jacob _nrn_jacob__Xmech
#define nrn_state _nrn_state__Xmech
#define _net_receive _net_receive__Xmech 
